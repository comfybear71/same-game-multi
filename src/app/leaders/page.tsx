    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="text-sm text-slate-400">
          Season {season} averages from settled game stats (updated with each
          morning settle). Benchmarking is relative to position — Elite→Average
          are the legs to prefer when building a multi.
        </p>
      </header>
